const AboutInfoBannerVid = require('../models/aboutInfoBannerVid.models')

//Find All
module.exports.findAllBuda = (req, res) => {
    AboutInfoBannerVid.find()
...
module.exports.createBuda = (req, res) => {
    AboutInfoBannerVid.create(req.body)
...
module.exports.findOneBuda = (req, res) => {
    AboutInfoBannerVid.findOne({ _id: req.params.id })
...
module.exports.updateBudda = (req, res) => {
    AboutInfoBannerVid.updateOne({ _id: req.params.id }, req.body, { new: true })
...
module.exports.deleteBudda = (req, res) => {
    AboutInfoBannerVid.deleteOne({_id: req.params.id})
