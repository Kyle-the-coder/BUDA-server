const BudaCrewInfo = require('../models/budaCrewInfo.models')
...
module.exports.findOneBuda = (req, res) => {
    BudaCrewInfo.findOne({ _id: req.params.id })
...
module.exports.updateBudda = (req, res) => {
    BudaCrewInfo.updateOne({ _id: req.params.id }, req.body, { new: true })
...
module.exports.deleteBudda = (req, res) => {
    BudaCrewInfo.deleteOne({_id: req.params.id})
