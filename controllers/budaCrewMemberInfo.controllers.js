const BudaCrewMemberInfo = require('../models/budaCrewMemberInfo.models')

//Find All
module.exports.findAllBuda = (req, res) => {
    BudaCrewMemberInfo.find()
...
module.exports.createBuda = (req, res) => {
    BudaCrewMemberInfo.create(req.body)
...
module.exports.findOneBuda = (req, res) => {
    BudaCrewMemberInfo.findOne({ _id: req.params.id })
...
module.exports.updateBudda = (req, res) => {
    BudaCrewMemberInfo.updateOne({ _id: req.params.id }, req.body, { new: true })
...
module.exports.deleteBudda = (req, res) => {
    BudaCrewMemberInfo.deleteOne({_id: req.params.id})
