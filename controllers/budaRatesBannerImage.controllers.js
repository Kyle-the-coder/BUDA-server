const BudaRatesBanner = require('../models/budaRatesBannerImage.models')

//Find All
module.exports.findAllBuda = (req, res) => {
    BudaRatesBanner.find()
...
module.exports.createBuda = (req, res) => {
    BudaRatesBanner.create(req.body)
...
module.exports.findOneBuda = (req, res) => {
    BudaRatesBanner.findOne({ _id: req.params.id })
...
module.exports.updateBudda = (req, res) => {
    BudaRatesBanner.updateOne({ _id: req.params.id }, req.body, { new: true })
...
module.exports.deleteBudda = (req, res) => {
    BudaRatesBanner.deleteOne({_id: req.params.id})
